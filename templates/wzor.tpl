...
<html>
	<head>
		<meta charset="utf-8">
		<title>{block name="tytul"}do zrobienia{/block}</title>
		<meta name="viewport" content="width=device-width, initial-scale=1.0">
		<link rel="stylesheet" href="//netdna.bootstrapcdn.com/bootswatch/3.0.1/amelia/bootstrap.min.css">
	...
	<body>
		...
		<div class="container">
			<div class="row">
				<div class="jumbotron">
					<h1>do zrobienia <small>wer. 0.4.3</small></h1>
					<p>
